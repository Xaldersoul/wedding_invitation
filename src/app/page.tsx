...
export default function Home() {
  return (
    <div>
      ...
      <ContentBlock
        Icon={<GiPartyPopper className="text-7xl sm:text-8xl text-silver-50" />}
      ...
      />
      <ContentBlock
        Icon={<FaMusic className="text-7xl sm:text-8xl text-silver-50" />}
      ...
      />
      <ContentBlock
        Icon={<GiLargeDress className="text-7xl sm:text-8xl text-silver-50" />}
        title="COLORES RESERVADOS"
        text="Informar que los colores Rojo, Azul y Lila estan reservados"
      />
      <ContentBlock
        Icon={
          <FaGlassCheers className="text-7xl sm:text-8xl text-nightblue-50" />
        }
